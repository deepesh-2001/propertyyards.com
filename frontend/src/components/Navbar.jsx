                  ...
                  <div ref={userRef} style={{ position: 'relative' }}>
                    ...
                    {userMenuOpen && (
                      <div style={{ ...s.dropdown, minWidth: 220 }} className="fade-in">
                        ...
                        <Link to="/crm"           onClick={() => setUserMenuOpen(false)} style={s.dropItem}>📋 CRM</Link>
                        <Link to="/analytics"     onClick={() => setUserMenuOpen(false)} style={s.dropItem}>📈 Analytics</Link>
                        <Link to="/ai-tools"      onClick={() => setUserMenuOpen(false)} style={s.dropItem}>✨ AI Tools</Link>
                        <Link to="/admin"         onClick={() => setUserMenuOpen(false)} style={s.dropItem}>⚙️ Admin Portal</Link>
                        <div style={s.dropDivider} />
                        <Link to="/payments"      onClick={() => setUserMenuOpen(false)} style={s.dropItem}>💳 Payments & Wallet</Link>
                        <Link to="/rewards"       onClick={() => setUserMenuOpen(false)} style={s.dropItem}>🎁 Rewards & Referrals</Link>
                        <Link to="/notifications" onClick={() => setUserMenuOpen(false)} style={s.dropItem}>🔔 Notifications</Link>
                        <Link to="/social-media"  onClick={() => setUserMenuOpen(false)} style={s.dropItem}>📱 Social Media</Link>
                        <Link to="/feedback"      onClick={() => setUserMenuOpen(false)} style={s.dropItem}>⭐ Reviews & Feedback</Link>
                        <div style={s.dropDivider} />
        ...
        <div style={s.drawer} className="fade-in">
          ...
          {isLoggedIn ? (
            <>
              ...
              <DrawerLink to="/crm"           label="📋 CRM" />
              <DrawerLink to="/analytics"     label="📈 Analytics" />
              <DrawerLink to="/ai-tools"      label="✨ AI Tools" />
              <DrawerLink to="/admin"         label="⚙️ Admin Portal" />
              <DrawerLink to="/payments"      label="💳 Payments" />
              <DrawerLink to="/rewards"       label="🎁 Rewards" />
              <DrawerLink to="/notifications" label="🔔 Notifications" />
              <DrawerLink to="/social-media"  label="📱 Social Media" />
              <DrawerLink to="/feedback"      label="⭐ Feedback" />
